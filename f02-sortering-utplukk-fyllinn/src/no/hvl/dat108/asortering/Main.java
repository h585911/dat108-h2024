...
public class Main {
	...
	public static void main(String[] args) {
		...
		Sammenligner<Person> fornavns = (a, b) -> a.fornavn().compareTo(b.fornavn());
//		Sammenligner<Person> fornavns = new Sammenligner<>() {
//			
//			@Override
...
//			}
//		};
		Utvalgssortering.sorter(listeAvPersoner, fornavns);
